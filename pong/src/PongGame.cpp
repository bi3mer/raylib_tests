...
void PongGame::draw() {
    ...
    DrawRectangleRounded(worldPlayerPaddle, paddleRounded, 1, RAYWHITE);
    DrawRectangleRounded(worldAIPaddle, paddleRounded, 1, RAYWHITE);

    // render ball
    DrawCircle(ball.x * W, ball.y * H, ballRadius*fmin(W, H), RED);
}
